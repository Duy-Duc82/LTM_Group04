...
int dao_rooms_mark_eliminated(int64_t room_id, int64_t user_id);  // Mark player as eliminated
int dao_rooms_delete(int64_t room_id);  // Delete room and all its members
